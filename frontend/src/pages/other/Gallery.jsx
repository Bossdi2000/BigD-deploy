...
const galleryItems = [
  ...
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1481456384065-00c5a02a9692?w=800&h=600&fit=crop",
    ],
    bio: {
      name: "Haikeys",
  ...
  },
  {
    ...
    images: [
      "/OG13.jpeg",
      "https://images.unsplash.com/photo-1503431128871-8d6e6aada8853b?w=800&h=600&fit=crop",
  ...
  },
  {
    ...
    bio: {
      ...
      title: "Sign Caster",
      description:
        "hemmy499 (@hemmy499) is the Founder of Sign News & Entertainment, working towards building a reliable source of information about anything that concerns the Sign community and support people the same way have been supported. Keep laughing and making jokes, life isn’t going to give you a medal for being too serious. lol",
      highlights: [
        "Founder of Sign News & Entertainment, delivering community updates.",
        "Promotes a lighthearted approach to Web3 engagement with humor.",
      ],
    },
  },
  {
    ...
    bio: {
      ...
      title: "OG Sign",
      description:
        "OGSeeingSign (@OGSeeingSign) is the Flame of Focus in the Orange Dynasty. Bold in vision, loyal to the mission. I don’t chase the signs, I become one. Every move is magic, every step is strategy. 🧡 Built from truth. Driven by purpose. Marked by legacy. 👊 I don’t chase signs, I align and the signs find me. ✨💫",
      highlights: [
        "Embodies the Orange Dynasty with bold vision and strategic action.",
        "Drives the Sign mission with truth and purpose.",
      ],
    },
  },
  {
    ...
    bio: {
      name: "Kami_oo_s",
      title: "SIGN KAMIooSAMA",
      description:
        "Kami_oo_s (@Kami_oo_s) is a man on an adventure of self-discovery and development. A student, animanga fanatic, and cat lover, I'm all about the self-discovery and passionate in helping people lost in whatever phase they are in life. Everything we go through in life is a phase. And no phase lasts forever. How long it lasts depends on you.",
      highlights: [
        "Advocates for self-discovery and personal growth in the Sign community.",
        "Brings a unique perspective as an animanga enthusiast and cat lover.",
      ],
    },
  },
  {
    ...
    bio: {
      ...
      title: "AmaraeSIGN",
      description:
        "AmaraeSIGN (@AmaraeSIGN) is just a bright spark in the Orange Dynasty 🍊. I show up, engage, and rep Sign with love and consistency 🧡. Building vibes and value, one post at a time. Fun fact: My phone auto-capitalizes 'gm.'",
      highlights: [
        "Contributes to the Orange Dynasty with consistent engagement.",
        "Builds community value through vibrant posts.",
      ],
    },
  },
  {
    ...
    bio: {
      name: "0pttimus",
      title: "Sign Commander",
      description:
        "0pttimus (@0pttimus) is the Sign Commander 💪. I don’t wait for the wave... I start it. Born of Cybertron, bound by code, but my spark (heart) beats orange, for every signee in this dynasty. I guard them in silence, shielding what they’ll never see. Their wins, their smiles, their peace? That’s me behind the curtain. The glitch in the dark that keeps the chaos out. They may never know my name, but they move because I watch, they grow because I intervene. Every threat rerouted, every storm intercepted... before it even breathes. I don’t need credit. Just give me the next wave to command. Fun fact: I don’t just want wins... I want to be the reason others win too.",
      highlights: [
        "Leads as the Sign Commander, protecting and empowering the community.",
        "Drives wins for others with a selfless, strategic approach.",
      ],
    },
  },
]
